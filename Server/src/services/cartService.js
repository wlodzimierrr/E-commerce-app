...
module.exports = class CartService {
    ...
    //     try {
    //         const { id: product_id, quantity: requestedQuantity }  = item;
    ...
    async addItem(user_id, { product_id, quantity }) {
        try {
            ...
            const existingItems = await CartItemModel.find(cart.cartid);
            ...
            if (existingItem) {
                ...
                const cartItem = await CartItemModel.create({ cart_id: cart.cartid, product_id, quantity });
                return cartItem;
            }
